        ...
        try:
            ...
            if metodo == 'box_counting':
                ...
                try:
                    ...
                    # --- NUEVO: OPTIMIZACIÓN AUTOMÁTICA PARA EL SERVIDOR ---
                    # Si la imagen mide más de 800 píxeles de ancho o alto, la achicamos
                    # manteniendo su proporción perfecta para no dañar el fractal.
                    max_size = 800
                    if max(img.size) > max_size:
                        img.thumbnail((max_size, max_size), Image.Resampling.LANCZOS)
                        print(f"Imagen redimensionada por seguridad a: {img.size}")
                    # ---------------------------------------------------------
